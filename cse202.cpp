...
void departmentmenu (linked * q) 
{
	...
	{
    system("cls");
	cout<<"\n\n\tWelcome To Department : " << q->departname;
...
int main ()
{
	...
	while(choice!=5)
	{
		strcpy(departments[0].departname,"Out Patient Department\n");
		strcpy(departments[1].departname,"Cardiology\n");
		strcpy(departments[2].departname,"Orthopedic\n");
		strcpy(departments[3].departname,"Gynecology\n");
		system("cls");
		cout<<"\n\t****************************          ";
		...
		for (i = 0; i < 4; i++)
		{
			cout<<"\t"<<(i+1)<<": "<<departments[i].departname;
		}
		cout<<"\t5: Exit";
		cout<<"\n\n\tPlease enter your choice : ";
		choice=readnumber();
